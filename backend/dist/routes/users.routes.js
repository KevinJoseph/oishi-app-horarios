...
import { createUserController, deleteUserController, listUsersController, validateCellphoneController, updateUserController } from '../controllers/users.controller.js';
import { requireAdmin, requireAuth } from '../middlewares/auth.middleware.js';
export const usersRouter = Router();
usersRouter.get('/users', requireAuth, requireAdmin, listUsersController);
